    ...
    public partial class ChatItem : UserControl
    {
        ...
        public ChatItem(IChatModel chatModel)
        {
            ...
            if (chatModel.Role != Roles.User)
            {
                ...
                bodyPanel.BackColor = Color.FromArgb(220, 220, 220);
                bodyTextBox.BackColor = Color.FromArgb(243, 243, 243); //Color.FromArgb(100, 101, 165);
            }
            else
            {
                bodyPanel.Dock = DockStyle.Fill;
            ...
            //Fills in the label. 
            if (chatModel.TimeStamp > DateTime.Today)
            {
                authorLabel.Text = $"{chatModel.Persona}, {chatModel.TimeStamp.ToShortTimeString()}";
            }
            else
            {
                authorLabel.Text = $"{chatModel.Persona}, {chatModel.TimeStamp.ToShortDateString()}";
            }
            ...
            switch (chatModel.Type)
            {
                case "text":
                    ...
                    bodyTextBox.Text = chatModel.UserOutputMessage;
                    break;
                    //case "image":
        ...
        public void ResizeBubbles(int maxwidth)
        {
            ...
            else
            {
                ...
                switch (ChatModel.Type)
                {
                    ...
                    //    break;
                    case "text":
                        var textmodel = ChatModel as MessageModel;
                        ...
                        string body = textmodel.UserOutputMessage;
